...
export const Icons = {
  ...
  logo: (props: LucideProps) => (
    <svg
      {...props}
      viewBox="0 0 512.3333 511.33334"
      version="1.1"
  ...
  Youtube(props: SVGProps<SVGSVGElement>) {
    return (
      ...
      >
        <title>YouTube</title>
        <path d="M23.499 6.173c-.273-1.022-.997-1.819-2.041-2.225C19.322 3.151 12 3.151 12 3.151s-7.322 0-9.458.797C1.498 4.354.774 5.151.501 6.173.145 7.694.001 9.366.001 11.039v1.922c0 1.673.144 3.345.5 4.866.273 1.022.997 1.819 2.041 2.225 2.136.797 9.458.797 9.458.797s7.322 0 9.458-.797c1.044-.406 1.768-1.203 2.041-2.225.356-1.521.5-3.193.5-4.866v-1.922c0-1.673-.144-3.345-.5-4.866zM9.546 15.406v-6.812l6.479 3.406-6.479 3.406z" />
      </svg>
    );
  },
  ...
  Email(props: SVGProps<SVGSVGElement>) {
    return (
      ...
      >
        <title>Email</title>
        <path d="M12 12.713l11.985-7.199C22.671 4.731 20.006 4 17.143 4H6.857C3.994 4 1.329 4.731.015 5.514L12 12.713zM12 14.888L.021 7.77C.008 8.513 0 9.258 0 10.007v4.986c0 2.9 2.357 5.258 5.257 5.258h13.486C21.643 20.251 24 17.893 24 14.993v-4.986c0-.749-.008-1.494-.021-2.237L12 14.888z" />
      </svg>
    );
  },
};
