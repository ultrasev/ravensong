  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="grid gap-6">
        <div
          className={`${young_serif.variable} font-young-serif p-4 border rounded`}
        >
        ...
        <div
          className={`${eagle_lake.variable} font-eagle-lake p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${courier_prime.variable} font-courier-prime p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${acclonica.variable} font-acclonica p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${protest_guerrilla.variable} font-protest-guerrilla p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${hachi_maru_pop.variable} font-hachi-maru-pop p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${noto_serif_sc.variable} font-noto-serif-sc p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${shippori_mincho_b1.variable} font-shippori-mincho-b1 p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${zen_old_mincho.variable} font-zen-old-mincho p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${zen_maru_gothic.variable} font-zen-maru-gothic p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${berkshire.variable} font-berkshire p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${comfortaa.variable} font-comfortaa p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
        ...
        <div
          className={`${space_grotesk.variable} font-space-grotesk p-4 border rounded`}
        >
          <p className="text-xl">{sampleText}</p>
